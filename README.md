...
## ⚙️ Automated Provisioning (Key Feature)
...
- Restrict SSH ingress to a single IP (`/32`)
...
This repository is intended as a **learning and portfolio project** and reflects
real‑world Terraform and AWS best practices without unnecessary abstraction.
